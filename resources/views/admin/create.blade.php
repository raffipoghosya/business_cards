                    ...
                    <form method="POST" action="{{ route('cards.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input id="title" class="block mt-1 w-full bg-white dark:bg-white border-gray-300 text-base text-gray-900 dark:text-gray-900 focus:border-gray-500 focus:ring-gray-500 rounded-md shadow-sm" type="text" name="title" value="{{ old('title') }}" required autofocus>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <!-- 
                              *** ՈՒՂՂՈՒՄԸ ԱՅՍՏԵՂ Է ***
                              Փոխում ենք $availableLinks as $link
                              -> $availableLinks as $linkKey => $linkLabel
                            -->
