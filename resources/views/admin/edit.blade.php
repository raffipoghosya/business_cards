<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Խմբագրել քարտը. {{ is_array($card->title) ? ($card->title['en'] ?? 'Digital Card') : $card->title }}
        </h2>
    </x-slot>
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 md:p-10 text-gray-900 dark:text-gray-900">
                    ...
                    <form method="POST" action="{{ route('cards.update', $card) }}" enctype="multipart/form-data">
                        ...
                        <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700/50 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-indigo-700/50 p-4 rounded-lg border border-indigo-600/50">
                                    ...
                                    <input id="title_en" class="block mt-1 w-full bg-gray-900 border-indigo-500 text-base text-black focus:border-indigo-400 focus:ring-indigo-400 rounded-md shadow-sm" 
                                           type="text" 
                                           name="title[en]" 
                                           value="{{ old('title.en', $card->title['en'] ?? '') }}" 
                                           required>
                                ...
                                <div class="bg-indigo-700/50 p-4 rounded-lg border border-indigo-600/50">
                                    ...
                                    <input id="subtitle_en" class="block mt-1 w-full bg-gray-900 border-indigo-500 text-base text-black focus:border-indigo-400 focus:ring-indigo-400 rounded-md shadow-sm" 
                                           type="text" 
                                           name="subtitle[en]" 
                                           value="{{ old('subtitle.en', $card->subtitle['en'] ?? '') }}">
                                ...
                                <div class="bg-orange-700/50 p-4 rounded-lg border border-orange-600/50">
                                    ...
                                    <input id="title_ru" class="block mt-1 w-full bg-gray-900 border-orange-500 text-base text-black focus:border-orange-400 focus:ring-orange-400 rounded-md shadow-sm" 
                                           type="text" 
                                           name="title[ru]" 
                                           value="{{ old('title.ru', $card->title['ru'] ?? '') }}">
                                ...
                                <div class="bg-orange-700/50 p-4 rounded-lg border border-orange-600/50">
                                    ...
                                    <input id="subtitle_ru" class="block mt-1 w-full bg-gray-900 border-orange-500 text-base text-black focus:border-orange-400 focus:ring-orange-400 rounded-md shadow-sm" 
                                           type="text" 
                                           name="subtitle[ru]" 
                                           value="{{ old('subtitle.ru', $card->subtitle['ru'] ?? '') }}">
                                ...
                                <div class="bg-red-700/50 p-4 rounded-lg border border-red-600/50">
                                    ...
                                    <input id="title_hy" class="block mt-1 w-full bg-gray-900 border-red-500 text-base text-black focus:border-red-400 focus:ring-red-400 rounded-md shadow-sm" 
                                           type="text" 
                                           name="title[hy]" 
                                           value="{{ old('title.hy', $card->title['hy'] ?? '') }}">
                                ...
                                <div class="bg-red-700/50 p-4 rounded-lg border border-red-600/50">
                                    ...
                                    <input id="subtitle_hy" class="block mt-1 w-full bg-gray-900 border-red-500 text-base text-black focus:border-red-400 focus:ring-red-400 rounded-md shadow-sm" 
                                           type="text" 
                                           name="subtitle[hy]" 
                                           value="{{ old('subtitle.hy', $card->subtitle['hy'] ?? '') }}">
                                ...
                                <div class="md:col-span-2 mt-4">
                                    ...
                                    <input id="slug" class="block mt-1 w-full bg-gray-900 border-gray-500 text-base text-black focus:border-indigo-400 focus:ring-indigo-400 rounded-md shadow-sm" 
                                           type="text" 
                                           name="slug" 
                                ...
                                {{-- Լոգոյի Փոփոխություն --}}
                                <div>
                                    <label for="logo" class="block font-semibold text-xl text-white">Փոխել Լոգոն</label>
                                    ...
                                    @if ($card->logo_path)
                                        <div class="mt-2">
                                            <span class="text-sm text-gray-400">Ընթացիկ լոգո:</span>
                                            <img src="{{ Storage::url($card->logo_path) }}" alt="Current Logo" class="mt-1 h-16 w-16 rounded-full object-cover border border-gray-700">
                                        </div>
                                    @endif
                                </div>

                                {{-- Ֆոնի նկարի Փոփոխություն --}}
                                <div>
                                    <label for="background_image" class="block font-semibold text-xl text-white">Փոխել ֆոնի նկարը</label>
                                    ...
                                    @if ($card->background_image_path)
                                        <div class="mt-2">
                                            <span class="text-sm text-gray-400">Ընթացիկ ֆոն:</span>
                                            <img src="{{ Storage::url($card->background_image_path) }}" alt="Current Background" class="mt-1 h-16 w-32 rounded-md object-cover border border-gray-700">
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        {{-- Դիզայնի Կարգավորումներ Բլոկ (Գույն-Թափանցիկություն Զույգերով) --}}
                        <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700/50 mb-8">
                            <h3 class="text-lg font-semibold text-black mb-4 flex items-center gap-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <input id="brand_color" type="color" name="brand_color" value="{{ old('brand_color', $card->brand_color) }}" class="block mt-1 w-full h-12 border-gray-600 bg-gray-900 focus:border-indigo-400 focus:ring-indigo-400 rounded-md shadow-sm cursor-pointer">
                                    <x-input-error :messages="$errors->get('brand_color')" class="mt-2" />
                                </div>
                                {{-- Աջ: Լոգոյի ֆոնի Թափանցիկություն --}}
                                <div>
                                    <label for="logo_bg_opacity" id="logo_bg_opacity_label" class="block font-semibold text-xl text-white">Լոգոյի ֆոնի թափանցիկություն: {{ old('logo_bg_opacity', $card->logo_bg_opacity) }}</label>
                                    <input 
                                        id="logo_bg_opacity" 
                                        type="range" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div class="md:col-span-1">
                                    ...
                                    <input id="title_color" type="color" name="title_color" value="{{ old('title_color', $card->title_color) }}" class="block mt-1 w-full h-12 border-gray-600 bg-gray-900 focus:border-indigo-400 focus:ring-indigo-400 rounded-md shadow-sm cursor-pointer">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input id="icon_bg_color" type="color" name="icon_bg_color" 
                                           value="{{ old('icon_bg_color', $card->icon_bg_color ?? '#ffffff') }}" 
                                ...
                                <div>
                                    <label for="icon_bg_opacity" id="icon_bg_opacity_label" class="block font-semibold text-xl text-white">Իկոնկաների ֆոնի թափանցիկություն: {{ old('icon_bg_opacity', $card->icon_bg_opacity ?? 1.0) }}</label>
                                    <input 
                                        id="icon_bg_opacity" 
                                        type="range" 
                                        name="icon_bg_opacity" 
                                        value="{{ old('icon_bg_opacity', $card->icon_bg_opacity ?? 1.0) }}" 
                                        min="0" max="1" step="0.01" 
                                        class="block mt-4 w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-indigo-500"
                        ...
                        {{-- Ֆոնի Մգացման (Overlay) Կարգավորումներ Բլոկ --}}
                        <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700/50 mb-8">
                            <h3 class="text-lg font-semibold text-black mb-4 flex items-center gap-2">
                        ...
                        {{-- Share Buttons Ֆոնի Կարգավորումներ Բլոկ --}}
                        <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700/50 mb-8">
                            <h3 class="text-lg font-semibold text-black mb-4 flex items-center gap-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-3 mt-1">
                                        <input type="color" id="share_btn_bg_color_picker"
                                            ...
                                            value="{{ old('share_btn_bg_color', $card->share_btn_bg_color ?? '#ffffff') }}"
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-4 mt-4">
                                        ...
                                        <span id="share_btn_bg_opacity_val" class="text-black font-mono w-12">
                                            {{ old('share_btn_bg_opacity', $card->share_btn_bg_opacity ?? 100) }}%
                                        </span>
                                    </div>
                        ...
                        {{-- «Պահպանել կոնտակտը» Կոճակի Կարգավորումներ Բլոկ --}}
                        <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700/50 mb-8">
                            <h3 class="text-lg font-semibold text-black mb-4 flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-3 mt-1">
                                        <input type="color" id="contact_btn_color_picker"
                                            class="h-10 w-10 rounded cursor-pointer border-0 p-0"
                                            value="{{ old('contact_btn_color', $card->contact_btn_color ?? '#555555') }}"
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-4 mt-4">
                                        <input type="range" id="contact_btn_opacity_range" name="contact_btn_opacity" min="0" max="100"
                                            value="{{ old('contact_btn_opacity', $card->contact_btn_opacity ?? 100) }}"
                                            class="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-indigo-500"
                                            oninput="document.getElementById('contact_btn_opacity_val').innerText = this.value + '%'">
                                        <span id="contact_btn_opacity_val" class="text-black font-mono w-12">
                                            {{ old('contact_btn_opacity', $card->contact_btn_opacity ?? 100) }}%
                                        </span>
                                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const logoSlider = document.getElementById('logo_bg_opacity');
            if (logoSlider) {
                updateOpacityLabel(logoSlider.value);
            }

            // Initialize Icon Slider
            const iconSlider = document.getElementById('icon_bg_opacity');
            if (iconSlider) {
                updateIconOpacityLabel(iconSlider.value);
            }
            
            // Initialize Background Overlay Opacity
            const overlaySlider = document.getElementById('bg_overlay_opacity');
            const overlayLabel = document.getElementById('bg_overlay_opacity_label');
            if (overlaySlider && overlayLabel) {
                 overlayLabel.innerText = 'Մգացման թափանցիկություն: ' + Number(overlaySlider.value).toFixed(2);
            }
            
            // Initialize Share Button Opacity
            ...
            // Initialize Contact Button Opacity
            const contactBtnOpacityRange = document.getElementById('contact_btn_opacity_range');
            const contactBtnOpacityVal = document.getElementById('contact_btn_opacity_val');
