            ...
            <div class="bg-gradient-to-br from-white to-gray-50 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 md:p-10 text-gray-900 dark:text-gray-900">
                    ...
                    <form method="POST" action="{{ route('cards.update', $card) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT') <div class="flex items-center border-b border-gray-200 pb-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-indigo-50 p-4 rounded-lg border border-indigo-100">
                                ...
                                <input id="title_en" class="block mt-1 w-full bg-white border-indigo-300 text-base text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" 
                                       type="text" 
                                       name="title[en]" 
                            ...
                            <div class="bg-indigo-50 p-4 rounded-lg border border-indigo-100">
                                ...
                                <input id="subtitle_en" class="block mt-1 w-full bg-white border-indigo-300 text-base text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" 
                                       type="text" 
                                       name="subtitle[en]" 
                            ...
                            <div class="bg-orange-50 p-4 rounded-lg border border-orange-100">
                                ...
                                <input id="title_ru" class="block mt-1 w-full bg-white border-orange-300 text-base text-gray-900 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm" 
                                       type="text" 
                                       name="title[ru]" 
                            ...
                            <div class="bg-orange-50 p-4 rounded-lg border border-orange-100">
                                ...
                                <input id="subtitle_ru" class="block mt-1 w-full bg-white border-orange-300 text-base text-gray-900 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm" 
                                       type="text" 
                                       name="subtitle[ru]" 
                            ...
                            <div class="bg-red-50 p-4 rounded-lg border border-red-100">
                                ...
                                <input id="title_hy" class="block mt-1 w-full bg-white border-red-300 text-base text-gray-900 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm" 
                                       type="text" 
                                       name="title[hy]" 
                            ...
                            <div class="bg-red-50 p-4 rounded-lg border border-red-100">
                                ...
                                <input id="subtitle_hy" class="block mt-1 w-full bg-white border-red-300 text-base text-gray-900 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm" 
                                       type="text" 
                                       name="subtitle[hy]" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input id="title_color" type="color" name="title_color" value="{{ old('title_color', $card->title_color) }}" class="block mt-1 w-full h-12 border-gray-300 dark:bg-white focus:border-gray-500 focus:ring-gray-500 rounded-md shadow-sm cursor-pointer">
...
<div>
    <label for="icon_bg_opacity" id="icon_bg_opacity_label" class="block font-semibold text-xl text-black dark:text-black">
        Իկոնկաների ֆոնի թափանցիկություն: {{ old('icon_bg_opacity', $card->icon_bg_opacity ?? 1.0) }}
    </label>
    <input 
        id="icon_bg_opacity" 
        type="range" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <div class="flex items-center gap-4 mt-4">
                ...
                <span id="share_btn_bg_opacity_val" class="text-white font-mono w-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <div class="flex items-center gap-4 mt-4">
                ...
                <span id="contact_btn_opacity_val" class="text-white font-mono w-12">
